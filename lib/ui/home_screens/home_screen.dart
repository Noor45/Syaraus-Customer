                                    ...
                                    if (snapshot.hasError) {
                                      ...
                                      return SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(userModel.fullName.toString(), style: GoogleFonts.inter(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 18, letterSpacing: 1)),
                                            const SizedBox(
                                              height: 4,
                                            ),
                                            Row(
                                              children: [
                                                ...
                                                Expanded(child: Text(controller.currentLocation.value, style: GoogleFonts.inter(color: Colors.white, fontWeight: FontWeight.w400))),
                                              ],
                                            ),
                                          ],
                                        ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text("Where you want to go?".tr, style: GoogleFonts.inter(fontWeight: FontWeight.w600, fontSize: 18, letterSpacing: 1)),
                                    const SizedBox(
                                      height: 10,
                                    ),
                                    controller.sourceLocationLAtLng.value.latitude == null
                                        ? InkWell(
                                            onTap: () async {
                                              ...
                                              // }
                                              print(controller.originCurrentLocationLAtLng.value);
                                              Navigator.push(
                                                context, MaterialPageRoute(
                                                  builder: (context) {
                                                    return FlutterPlacePicker(
                                                    apiKey: 'YOUR KEY HERE',
                                                    initialPosition: controller.originCurrentLocationLAtLng.value,
                                                    useCurrentLocation: false,
                                                    selectInitialPosition: true,
                                                    usePlaceDetailSearch: true,
                                                    strictBounds: false, region: 'pk',
                                                    ...
                                                    onPlacePicked: (result) {
                                                        if (result != null) {
                                                          ...
                                                          controller.originCurrentLocationLAtLng.value = LatLng(result.geometry!.location.lat, result.geometry!.location.lng);
                                                          controller.calculateAmount();
                                                        }
                                                        Get.back();
                                                      },
                                                        ...
                                                        onTap: () async {
                                                          ...
                                                          Navigator.push(
                                                            ...
                                                            builder: (context) {
                                                              return FlutterPlacePicker(
                                                                apiKey: 'YOUR KEY HERE',
                                                                initialPosition: controller.stopCurrentLocationLAtLng.value,
                                                                useCurrentLocation: false,
                                                                selectInitialPosition: true,
                                                                usePlaceDetailSearch: true,
                                                                strictBounds: false, region: 'pk',
                                                                ...
                                                                onPlacePicked: (result) {
                                                                  if (result != null) {
                                                                    controller.destinationLocationController.value.text = result.formattedAddress.toString();
                                                                    controller.destinationLocationLAtLng.value = LocationLatLng(latitude: result.geometry!.location.lat, longitude: result.geometry!.location.lng);
                                                                    controller.stopCurrentLocationLAtLng.value = LatLng(result.geometry!.location.lat, result.geometry!.location.lng);
                                                                    controller.calculateAmount();
                                                                  }
                                    ...
                                    Text("Select Vehicle".tr, style: GoogleFonts.inter(fontWeight: FontWeight.w500, letterSpacing: 1)),
                                    const SizedBox(
                                      height: 05,
                                    ),
                                    SizedBox(
                                    ...
                                    Visibility(
                                      visible: Constant.userModel!.gender == 'Female' ? true : false,
                                      child: Row(
                                        ...
                                        children: [
                                          Transform.scale(
                                            ...
                                            child: Theme(
                                              ...
                                              child: Checkbox(
                                                value: controller.preferFemaleDriver.value,
                                                shape: RoundedRectangleBorder(
                                                  borderRadius: BorderRadius.circular(5.0),
                                                ),
                                                onChanged: (bool? value) {
                                                  controller.preferFemaleDriver.value = value!;
                                                },
                                              ),
                                            ),
                                          ),
                                    ...
                                    ButtonThem.buildButton(
                                      ...
                                      onPress: () async {
                                        ...
                                        if (controller.selectedPaymentMethod.value.isEmpty) {
                                          ...
                                          orderModel.femalePreference = controller.preferFemaleDriver.value;

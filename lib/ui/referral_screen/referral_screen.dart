...
class ReferralScreen extends StatelessWidget {
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  ...
                                  style: GoogleFonts.inter(fontWeight: FontWeight.w600, color: themeChange.getThem() ? Colors.white : Colors.black, fontSize: 22),
                                ),
                              ],
                            ),
                          ),
                                ...
                                child: SingleChildScrollView(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "Invite Syaraus to sign up using your link and you’ll get ${Constant.amountShow(amount: Constant.referralAmount.toString())}  ".tr,
                                          ...
                                          child: Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Text("Tap to Copy".tr, style: GoogleFonts.inter(fontWeight: FontWeight.w200))
                                              ],
                                            ),
                                          ),
                                        ),
  ...
  Future<void> share(ReferralController controller) async {
    ...
    await FlutterShare.share(
      title: 'Syaraus'.tr,
      text:
      'Hey there, thanks for choosing Syaraus. Hope you love our product. If you do, share it with your friends using code ${controller.referralModel.value.referralCode.toString()} and get ${Constant.amountShow(amount: Constant.referralAmount)}.'.tr,
    );
  }
}

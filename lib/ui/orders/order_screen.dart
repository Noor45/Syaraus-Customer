                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        Expanded(
                                                                          child: Row(
                                                                            children: [
                                                                              Text(orderModel.someOneElse!.fullName.toString().tr, style: GoogleFonts.inter()),
                                                                              Text(orderModel.someOneElse!.contactNumber.toString().tr, style: GoogleFonts.inter(fontWeight: FontWeight.w600, fontSize: 12)),
                                                                            ],
                                                                          ),
                                                                        ),
                                                                        InkWell(onTap: () async {
                                                                  ...
                                                                  children: [
                                                                    Expanded(
                                                                      child: orderModel.status == Constant.rideInProgress ||
                                                                          ...
                                                                          : Row(
                                                                              children: [
                                                                                Text("OTP".tr, style: GoogleFonts.inter()),
                                                                                Text(" : ${orderModel.otp}", style: GoogleFonts.inter(fontWeight: FontWeight.w600, fontSize: 12)),
                                                                              ],
                                                                            ),
                                                                    ),
                                                                    Text(Constant().formatTimestamp(orderModel.createdDate), style: GoogleFonts.inter(fontSize: 12)),
                                                                  ],
                                                                )),
                                                          ),
                                                        ),
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Padding(
                                                                  ...
                                                                  child: Center(
                                                                    child: Row(
                                                                      children: [
                                                                        Expanded(child: Text(orderModel.status.toString(), style: GoogleFonts.inter(fontWeight: FontWeight.w500))),

              ...
              child: Padding(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("FAQs".tr, style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w600)),
                      Text("Read FAQs solution".tr, style: GoogleFonts.inter()),
                      const SizedBox(
                        height: 20,
                      ),
                      Expanded(
                                        ...
                                        return InkWell(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: ExpansionTile(
                                                title: Text(faqModel.title.toString(), style: GoogleFonts.inter()),
                                                children: <Widget>[
                                                  ListTile(
                                                    title: Text(faqModel.description.toString(), style: GoogleFonts.inter()),
                                                  ),
                                                ],
                                              ),
                                            ),

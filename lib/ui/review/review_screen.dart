                              ...
                              child: Column(
                                children: [
                                  ...
                                  Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: [
                                      Text("${controller.driverModel.value.vehicleInformation!.vehicleNumber}", style: GoogleFonts.inter(fontWeight: FontWeight.w700)),
                                      const SizedBox(
                                        width: 10,
                                      ),
                                      Text("${controller.driverModel.value.vehicleInformation!.vehicleType}", style: GoogleFonts.inter(fontWeight: FontWeight.w500)),
                                      const SizedBox(
                                        width: 10,
                                      ),
                                      Text("${controller.driverModel.value.vehicleInformation!.vehicleColor}", style: GoogleFonts.inter(fontWeight: FontWeight.w700)),
                                    ],
                                  ),
                                  const SizedBox(
                                    height: 20,

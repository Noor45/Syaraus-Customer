                              ...
                              child: DefaultTabController(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text("Contact us".tr, style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w600)),
                                      Text("Let us know your issue & feedback".tr, style: GoogleFonts.inter()),
                                      const SizedBox(
                                        height: 20,
                                      ),
                                      TabBar(
                                            ...
                                            Padding(
                                              ...
                                              child: SingleChildScrollView(
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    Text("Write us".tr, style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w600)),
                                                    Text("Describe your issue".tr, style: GoogleFonts.inter()),
                                                    const SizedBox(
                                                      height: 20,
                                                    ),

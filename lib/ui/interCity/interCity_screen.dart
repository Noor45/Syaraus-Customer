                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                      onTap: () async {
                                        await Utils().handlePressButton(context).then((cityValue) {
                                          print(cityValue?.result.geometry!.location.lng);
                                          print(cityValue?.result.geometry!.location.lat);
                                          if (cityValue != null) {
                                            Navigator.push(
                                              ...
                                              builder: (context) {
                                                return FlutterPlacePicker(
                                                  ...
                                                  initialPosition: LatLng(cityValue.result.geometry!.location.lat, cityValue.result.geometry!.location.lng),
                                                  useCurrentLocation: false,
                                                  selectInitialPosition: true,
                                                  usePlaceDetailSearch: true,
                                                  strictBounds: true, region: 'pk',
                                  ...
                                  Text("Select Option".tr, style: GoogleFonts.inter(fontWeight: FontWeight.w500, letterSpacing: 1)),
                                  const SizedBox(
                                    height: 05,
                                  ),
                                  SizedBox(
                                  ...
                                  InkWell(
                                      onTap: () async {
                                        BottomPicker.dateTime(
                                          pickerTextStyle: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15),
                                          onSubmit: (index) {
                                      ...
                                      : controller.selectedInterCityType.value.id == "Kn2VEnPI3ikF58uK8YqY"
                                          ? Column(
                                              children: [
                                                ...
                                                // Row(
                                                //   children: [
                                                //     Expanded(child: Text("Loader needed".tr, style: GoogleFonts.inter(fontWeight: FontWeight.w500, letterSpacing: 1))),
